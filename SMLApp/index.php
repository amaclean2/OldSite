<?php
	...
	if(isset($_POST['send']))
	{
        ...
        $to = "andrew.n.maclean@gmail.com";

        $headers = "From: " . $name . " at " . $company;
        $sent = mail($to, "Quote Request", $message, $headers);
        $_SESSION['email'] = 'true';
    }
?>
<!DOCTYPE html>
		...
		<div class = "non-movable">
			...
			<header>
				<ul>
					...
					<div class = "db"><a href = "login.php"><i class="fa fa-database" aria-hidden="true"></i> <span class = "icon-text">Login to Database</span></a></div>
				</ul>
			...
			<div class = "certifications">
				<img src = "smlengineering/AS9100-logo.jpg" alt = "AS9100 Certified" id = "AS-logo" class = "certs" />
				<img src = "smlengineering/ISO-Certified.png" alt = "ISO Cerfitied" id = "ISO-logo" class = "certs" />
				<img src = "smlengineering/ISA-logo2.jpg" alt = "ISA Certified" id = "ISA-logo" class = "certs" />
			</div>
		</div>
		<div class = "front">
			<div class = "motto-small">
				...
				<div class = "button-small">
					...
					<a href = "login.php" id = "db-small"><i class="fa fa-database" aria-hidden="true"></i> <span class = "icon-text">Login to Database</span></a>
				</div>
			</div>
		</div>
		<div class = "wrapper">
			<div id = "home">
				...
				<div class = "split-div uneven-small">
					<img src = "smlengineering/partImage.png" alt = "Mill Parts" id = "cap-part"/>
				</div>
			...
			<div id = "processes">
				...
				<div class = "split-div uneven-small">
					<img src = "smlengineering/platingImage.png" alt = "plating" id = "cap-part2" />
				</div>
			</div>
			<div id = "materials">
					...
					<div class = "split-div quote">
						...
						<form action="index.php" method="post">
							...
							<div class = "end-buttons">
								<button type="submit" name  "send"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</input>
